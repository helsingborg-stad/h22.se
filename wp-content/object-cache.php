...
if (
    ...
    function wp_cache_set_multi($items, $expire = 0, $group = 'default')
    {
        ...
        return $wp_object_cache->set_multi(
            $items,
            $expire = 0,
            $group = 'default'
        );
    ...
    class WP_Object_Cache
    {
        ...
        function key($key, $group)
        {
            ...
            return preg_replace(
                '/\s+/',
                '',
                WP_CACHE_KEY_SALT . "$prefix$group:$key"
            );
        }
        ...
        function set($id, $data, $group = 'default', $expire = 0)
        {
            ...
            if (
                isset($this->cache[$key]) &&
                'checkthedatabaseplease' === $this->cache[$key]
            ) {
                return false;
            }
        ...
        function stats()
        {
            ...
            foreach ($this->group_ops as $group => $ops) {
                if (!isset($_GET['debug_queries']) && 500 < count($ops)) {
                    ...
                    echo "<big>Too many to show! <a href='" .
                        add_query_arg('debug_queries', 'true') .
            ...
            if (function_exists('is_multisite')) {
                $this->global_prefix =
                    ...
                    (defined('CUSTOM_USER_TABLE') &&
                        ...
                        : $table_prefix;
                $this->blog_prefix =
                    (is_multisite() ? $blog_id : $table_prefix) . ':';
            }
