...
namespace H22\Plugins\VisualComposer\Components\VcColumnInner;
...
if (!class_exists('\H22\Plugins\VisualComposer\Components\VcColumnInner\VcColumnInner')) :
    class VcColumnInner
    {
        ...
        public function changeTemplateSource()
        {
            \WPBMap::modify(
                'vc_column_inner',
                'html_template',
                dirname(__FILE__) . '/VcColumnInner.php'
            );
        }

        public function adminJS()
        {
            \WPBMap::modify('vc_column_inner', 'js_view', 'ViewVcColumnInnerModule');
            \WPBMap::modify(
                'vc_column_inner',
                'admin_enqueue_js',
                \H22\Helper\FileSystem::themeUrl(dirname(__FILE__)) .
                    '/js/vc_column_inner.js'
            );
        }
        ...
        public function removeParams()
        {
            ...
            vc_remove_param('vc_column_inner', 'video_bg');
            vc_remove_param('vc_column_inner', 'video_bg_url');
            vc_remove_param('vc_column_inner', 'video_bg_parallax');
            vc_remove_param('vc_column_inner', 'parallax');
        ...
        public function updateParams()
        {
            ...
            $param = WPBMap::getParam('vc_column_inner', 'offset');
            $param['type'] = 'column_offset_mod';
            WPBMap::mutateParam('vc_column_inner', $param);
            ...
            $param = WPBMap::getParam('vc_column_inner', 'el_id');
            $param['group'] = __('Settings', 'h22');
            WPBMap::dropParam('vc_column_inner', $param['param_name']);
            WPBMap::addParam('vc_column_inner', $param);
        ...
        {
            $this->generalThemeParams('vc_column_inner');
            $this->generalBackgroundParams('vc_column_inner');
            $this->generalTextColorParams('vc_column_inner');
        ...
        public function prepareData($data)
        {
            ...
            if (isset($data['bg_image_src']) && $data['bg_image_src'] === 'featured_image') {
                ...
                $data['bg_image'] = apply_filters('H22/Plugins/VisualComposer/Components/VcColumnInner/bgImage', $data['bg_image']);
            }
...
/**
 * From wp-content/plugins/js_composer/include/templates/shortcodes/vc_column_inner.php
 ...
 */
if (isset($atts)) :
    $element = new VcColumnInner();
    echo $element->output($atts, $content, 'vc_column_inner');
endif;
