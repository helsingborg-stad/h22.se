window.ViewVcRowInnerModule = window.VcRowView.extend({
	// Render method called after element is added( cloned ), and on first initialisation
	render: function() {
		window.ViewVcRowInnerModule.__super__.render.call(this); //make sure to call __super__. To execute logic fron inherited view. That way you can extend original logic. Otherwise, you will fully rewrite what VC will do at this event
		this.renderMobileInvertedColumns(this.model);

		return this;
	},
	ready: function(e) {
		window.ViewVcRowInnerModule.__super__.ready.call(this, e);

		return this;
	},
	//Called every time when params is changed/appended. Also on first initialisation
	changeShortcodeParams: function(model) {
		window.ViewVcRowInnerModule.__super__.changeShortcodeParams.call(this, model);

		this.renderMobileInvertedColumns(this.model);
	},
	changeShortcodeParent: function(model) {
		window.ViewVcRowInnerModule.__super__.changeShortcodeParent.call(this, model);
	},
	deleteShortcode: function(e) {
		window.ViewVcRowInnerModule.__super__.deleteShortcode.call(this, e);
	},
	editElement: function(e) {
		window.ViewVcRowInnerModule.__super__.editElement.call(this, e);
	},
	clone: function(e) {
		window.ViewVcRowInnerModule.__super__.clone.call(this, e);
	},
