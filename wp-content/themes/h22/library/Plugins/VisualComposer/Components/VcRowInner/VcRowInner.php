...
namespace H22\Plugins\VisualComposer\Components\VcRowInner;

use H22\Plugins\VisualComposer\Components\BaseComponentController;

if (!class_exists('\H22\Plugins\VisualComposer\Components\VcRowInner\VcRowInner')) :
    class VcRowInner extends \WPBakeryShortCodesContainer
    {
        ...
        public function changeTemplateSource()
        {
            \WPBMap::modify(
                'vc_row_inner',
                'html_template',
                dirname(__FILE__) . '/VcRowInner.php'
            );
        }

        public function adminJS()
        {
            \WPBMap::modify('vc_row_inner', 'js_view', 'ViewVcRowInnerModule');
            \WPBMap::modify(
                'vc_row_inner',
                'admin_enqueue_js',
...
/**
 * From wp-content/plugins/js_composer/include/templates/shortcodes/vc_row_inner.php
...
if (isset($atts)) :
    $row = new VcRowInner();
    echo $row->output($atts, $content, 'vc_row_inner');
endif;
