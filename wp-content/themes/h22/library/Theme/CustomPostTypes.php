...
class CustomPostTypes
{
    public function __construct()
    {
        ...
        new \H22\Entity\PostType(
            _x('Toolboxes', 'Post type plural', 'h22'),
            _x('Toolbox', 'Post type singular', 'h22'),
            'toolbox',
            array(
                'description' => __('H22 Projects', 'h22'),
                'menu_icon' => 'dashicons-portfolio',
        ...
        new \H22\Entity\PostType(
            _x('Partners', 'Post type plural', 'h22'),
            _x('Partner', 'Post type singular', 'h22'),
            'partners',
            array(
                'description' => __('H22 Partners', 'h22'),
                'menu_icon' => 'dashicons-portfolio',
                'public' => true,
                'publicly_queriable' => true,
                'show_ui' => true,
